...
const ProgressTracker = ({ progress, points, chapters, onChapterSelect, currentChapter, sidebarWidth = 256 }) => {
  ...
  return (
    <div className="p-6">
      {/* Progress Overview */}
      <div className="mb-8">
        <h3 className="text-lg font-bold text-navy-800 dark:text-white mb-4">Your Progress</h3>
        ...
        <div className={`grid gap-4 ${sidebarWidth < 280 ? 'grid-cols-1' : 'grid-cols-2'}`}>
          <div className="bg-silver-50 dark:bg-silver-800 rounded-lg p-3">
            <p className="text-xs text-silver-600 dark:text-silver-400 mb-1">Points</p>
            <p className="text-lg font-bold text-navy-800 dark:text-white">{points}</p>
          </div>
          <div className="bg-silver-50 dark:bg-silver-800 rounded-lg p-3">
            <p className="text-xs text-silver-600 dark:text-silver-400 mb-1">Chapters</p>
      ...
      {/* Chapter List */}
      <div>
        <h3 className="text-lg font-bold text-navy-800 dark:text-silver-100 mb-4">Chapters</h3>
      ...
      {/* Achievements */}
      <div className="mt-8">
        <h3 className="text-lg font-bold text-navy-800 dark:text-white mb-4">Achievements</h3>
        <div className={`grid gap-2 ${sidebarWidth < 280 ? 'grid-cols-1' : 'grid-cols-3'}`}>
          <div className="text-center">
            ...
            <p className="text-xs mt-1 text-navy-800 dark:text-silver-300">First Steps</p>
          </div>
          <div className="text-center">
            <div className={`w-12 h-12 mx-auto rounded-full flex items-center justify-center ${
            ...
            <p className="text-xs mt-1 text-navy-800 dark:text-silver-300">Rising Star</p>
          </div>
          <div className="text-center">
            <div className={`w-12 h-12 mx-auto rounded-full flex items-center justify-center ${
